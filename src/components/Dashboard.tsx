    ...
    <>
      ...
      <main class="max-w-7xl py-12 w-full mx-auto px-4 lg:px-0">
        <div class="w-full grid gap-4 text-center mb-12">
          <div class="text-5xl text-neutral-800 border-b pb-4 border-neutral-800">
            Project Dashboard
          </div>
          {syncStatus() ? (
        ...
        <Show
          when={collections() && collections()!.length > 0}
          fallback={<Loading />}
        >
                  ...
                  <>
                    ...
                    <div class="h-full w-full flex gap-2 items-center text-sm">
                      ...
                      <A
                        ...
                        onclick={() => {
                          setProject(project);
                          setAuthEndpoint(Endpoint.DELETE_COLLECTION);
                          setAuthSignal(true);
                        }}
                      >
                        Delete
          ...
          <div class="lg:col-span-2 flex justify-center">
            ...
            <button
              ...
              onClick={() => {
                ...
                setProject(new ProjectFactory().default(newProjectId));
                setAuthEndpoint(Endpoint.CREATE_COLLECTION);
                setAuthSignal(true);
              }}
            >
              Add Project
