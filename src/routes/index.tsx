...
export default function Home() {
  ...
  return (
    <Show when={projects()} fallback={<Loading />}>
      <main class="mx-auto">
        <div class="px-2 xl:px-0 border-b border-neutral-800 bg-gradient-to-br from-25% to-100% to-neutral-950 from-neutral-900 py-24 flex items-center">
          <div class="py-8 xl:py-0 rounded max-w-5xl lg:flex grid gap-6 justify-between items-center mx-auto text-center lg:text-left">
            <div class="hover:scale-110 rounded-xl transition-all duration-1000 ease-in-out h-full w-full mx-auto max-w-[360px] max-h-[360px] overflow-hidden">
              <img
            ...
            <div class="w-full grid gap-2 mx-auto text-neutral-300">
              ...
              <p class="backdrop-brightness-150 p-6 rounded-lg text-neutral-300 max-w-3xl xl:max-w-[100vw] mb-4 mt-8 text-center lg:text-left">
                I specialize in design, advertising campaigns, web design &
                development, editing, and digital marketing. <strong>Reach out! I'd love
