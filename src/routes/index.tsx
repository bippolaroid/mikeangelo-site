...
export default function Home() {
  ...
  return (
    <Show when={projects()} fallback={<Loading />}>
      <main class="mx-auto">
        <div class="px-4 2xl:px-0 border-b border-neutral-800 bg-gradient-to-br from-25% to-100% to-neutral-950 from-neutral-900 py-12 lg:py-24 flex items-center">
          <div class="py-8 xl:py-0 rounded max-w-5xl lg:flex grid gap-6 lg:gap-0 justify-between items-center mx-auto text-center lg:text-left">
            <div class="w-full grid mx-auto text-neutral-300">
              <div class="w-full grid gap-2 border-t border-b border-neutral-900 py-12">
                ...
                <p class="lg:mr-4 backdrop-brightness-150 p-4 rounded text-neutral-400 ring ring-neutral-800 max-w-3xl xl:max-w-[100vw] mb-4 mt-2 text-center lg:text-left">
            ...
            <div class="border border-neutral-900 p-4">
            <div class="transition-all duration-1000 ease-in-out h-full w-full mx-auto max-w-[360px] max-h-[360px] overflow-hidden">
              <img
        ...
        <div class="bg-neutral-900 px-4 py-24 2xl:px-0">
          <h1 class="text-center text-neutral-800 text-5xl mb-6 tracking-widest uppercase font-light">
            Portfolio
          </h1>
