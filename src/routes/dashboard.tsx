...
import { serverCheck } from "~/utils/server_utils";
  ...
  function refresh() {
    return (
      <div class="w-full grid gap-4 justify-center">
        ...
        <button
          class="w-fit mx-auto px-4 py-2 ring ring-neutral-950 text-neutral-50 hover:text-neutral-950 rounded cursor-pointer bg-neutral-950 hover:bg-neutral-50"
          onclick={() => {
